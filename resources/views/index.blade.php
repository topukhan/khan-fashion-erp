...
<head>
    ...
    <link href="{{ asset('ui/css/app.css') }}" rel="stylesheet"/>
    {{-- @vite('resources/css/app.css') --}}
    <script src="https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.min.js" defer></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.min.js" defer></script>
    <script src="{{ asset('ui/js/app.js') }}"></script>
    <script src="{{ asset('ui/js/init-alpine.js') }}"></script>
    <script src="{{ asset('ui/js/charts-lines.js') }}" defer></script>
    <script src="{{ asset('ui/js/charts-pie.js') }}" defer></script>
</head>
